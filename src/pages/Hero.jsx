...
export default function Hero() {
  return (
    <main className="overflow-hidden bg-[#FFFFFF] text-left transition-colors duration-300 dark:bg-[#050B18]">
      <section className="relative mx-auto grid min-h-[calc(100svh-70px)] max-w-[88rem] items-center gap-12 px-6 py-16 sm:py-20 lg:min-h-[calc(100svh-84px)] lg:grid-cols-[1.02fr_0.98fr] lg:gap-16 lg:px-8 lg:py-24 xl:gap-20">
        <div className="pointer-events-none absolute right-0 top-12 h-80 w-80 bg-[#38BDF8]/20 blur-3xl dark:bg-[#38BDF8]/15" />
        ...
        <div className="relative z-10">
          ...
          <h1 className="max-w-5xl text-5xl font-black leading-[1.02] text-[#0F172A] sm:text-6xl lg:text-7xl xl:text-8xl dark:text-[#F8FBFF]">
            Custom software development services for growing businesses.
          </h1>

          <p className="mt-7 max-w-3xl text-lg font-medium leading-8 text-[#0F172A]/70 md:text-xl lg:text-[22px] lg:leading-9 dark:text-white/70">
          ...
          <div className="mt-12 grid max-w-3xl gap-3 sm:grid-cols-3">
            {heroStats.map((stat) => (
              <div
                key={stat.value}
                className="border-l-4 border-[#38BDF8] bg-[#F8FBFF] px-4 py-3 dark:bg-[#0B1A2D]"
              >
